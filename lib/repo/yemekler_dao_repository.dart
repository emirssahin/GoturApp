...
import 'package:gotur_app/entity/yemekler_cevap.dart';
import 'package:gotur_app/entity/sepet_yemekler_cevap.dart';
import 'dart:convert';
...
class YemeklerDaoRepository {
  ...
  parseSepettekiYemeklerCevap(String cevap) {
    try {
      return SepetYemeklerCevap.fromJson(json.decode(cevap))
          .sepetYemeklerListesi;
    } catch (e) {
      print("Sepet boş");
    }
  }
